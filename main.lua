...
local Alr = Window:CreateTab("Codes from Simple Hub V1", 4483362458) 

local Section = Tab:CreateSection("Tools")
local SlapBattles = Tab3:CreateButton({
    Name = "Simple Hub Slap Battles Hitbox Expander",
    Callback = function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/Alr-Dev/SimpleHub-V1/refs/heads/main/scriptsbyalrdev/hitboxslapbattles.lua"))()
    end,
 })

local DEX = Tab3:CreateButton({
    Name = "Dex V2 (UNDECTATABLE VERSION)",
    Callback = function()
